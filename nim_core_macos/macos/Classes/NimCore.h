...
using NimResultCallback = std::function<void(const flutter::EncodableValue* resultData, bool bNotImplemented)>;
...
public:
    MockMethodResult(const std::string serviceName, const std::string methodName, const NimResultCallback& resultCallback);
