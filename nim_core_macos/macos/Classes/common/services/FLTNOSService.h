...
private:
    void upload(const flutter::EncodableMap* arguments, std::shared_ptr<flutter::MethodResult<flutter::EncodableValue>> result);
    void download(const flutter::EncodableMap* arguments, std::shared_ptr<flutter::MethodResult<flutter::EncodableValue>> result);
...
private:
    ...
    void downloadMediaExCallback(nim::NIMResCode res_code, const nim::DownloadMediaResult& result);
private:
    std::shared_ptr<flutter::MethodResult<flutter::EncodableValue>> m_uploadResult;
};
