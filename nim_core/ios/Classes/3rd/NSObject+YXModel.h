 ...
 Sample Code:
     ...
     ********************** json convertor *********************
     ...
     int main() {
         ...
         YXBook *book = [YXBook yx_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
     ...
     ********************** Coding/Copying/hash/equal *********************
     ...
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self yx_modelInitWithCoder:aDecoder]; }
