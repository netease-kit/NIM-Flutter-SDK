...
class QChatSendMessageParam {
  ...
  /// 消息附件，通过QChatNIMMessageAttachment#toMap()获得

  String? attach;

  /// 推荐使用此接口设置附件
  void setAttachment(QChatNIMMessageAttachment attachment) {
...
class QChatMessage {
  ...
  @JsonKey(
      fromJson: QChatNIMMessageAttachment.fromJson,
      toJson: QChatNIMMessageAttachment.toJson)
