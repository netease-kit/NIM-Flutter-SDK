...
import 'package:nim_core_v2_platform_interface/src/method_channel/method_channel_signalling_service.dart';

abstract class SignallingServicePlatform extends Service {
  SignallingServicePlatform() : super(token: _token);

  static final Object _token = Object();

  static SignallingServicePlatform _instance = MethodChannelSignallingService();

  static SignallingServicePlatform get instance => _instance;

  static set instance(SignallingServicePlatform instance) {
    PlatformInterface.verifyToken(instance, _token);
    _instance = instance;
  }

  /// 在线事件回调
  Stream<NIMSignallingEvent> get onOnlineEvent;
