...
import com.netease.nimlib.sdk.v2.common.V2NIMPostscript
...
fun V2NIMFriendAddApplication.toMap(): Map<String, Any?> {
    return mapOf(
        ...
        "updateTimestamp" to this.updateTimestamp,
        "postscriptHistory" to this.postscriptHistory.map { postscript -> postscript.toMap() }
    )
}

fun V2NIMPostscript.toMap(): Map<String, Any?> {
    return mapOf(
        "fromAccount" to this.fromAccount,
