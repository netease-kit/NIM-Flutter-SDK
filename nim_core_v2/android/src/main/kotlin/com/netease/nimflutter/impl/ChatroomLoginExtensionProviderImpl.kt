...
class ChatroomLoginExtensionProviderImpl(val serviceName: String, val nimCore: NimCore, val instanceId: Int) : V2NIMChatroomLoginExtensionProvider {
    private val chatroomLinkProviderTimeout = 500L
    override fun getLoginExtension(roomId: String?, accountId: String?): String? {
        return runBlocking {
